...
**If those prior-version files become available in a future session**, they should be:
...
Until then, this folder remains empty and `_consolidation/conflict-register.md` item C5 stays flagged as an open evidentiary gap.

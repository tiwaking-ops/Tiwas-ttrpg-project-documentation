...
consolidation_note: >
  ...
  UNMODIFIED from sources/tiwas-canonical-rules-and-changelog-v1.3.md (verify
  by diff if needed). No wording below this header was altered, added, or
  removed. This placement reflects the document's own self-declared Canonical

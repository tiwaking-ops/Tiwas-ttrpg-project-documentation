---
document:
  title: "Tiwas TTRPG — Cross-LLM Combat Playtest Comparative Systems Readiness Report"
  version: "1.0"
...
# Tiwas TTRPG — Cross-LLM Combat Playtest Comparative Systems Readiness Report
...
1. **Claude Sonnet 5** — short execution / abort.
2. **Grok 4.5** — independent full execution to PC incapacitation.
3. **GPT-5.6 Luna** — continuation of the Claude execution through PC incapacitation.
...
The combined Claude → Luna lineage therefore demonstrates:
...
| Overflow → HP | Exercised | Exercised | Exercised | **Confirmed Working** |
...
| Advanced Skills | Medium–High | Claude/Luna exercised | **Working** |
...
The Grok execution alone ran for 22 rounds, while the Claude → Luna lineage successfully continued from an interrupted state to terminal incapacitation.
...
## Priority P0 — Required for Deterministic Full Combat
...
## Priority P1 — Required for Broad Combat Fidelity
...
## Priority P2 — Required for Full Adventure Playtesting
...
**NO — not yet ready for a full-fidelity adventure playtest.**
...
## Phase 1 — Close the Combat Execution Interface
...
5. Quality → gated Effect threshold.
...
## Phase 2 — Complete the Combat Consequence Layer
...
## Phase 4 — Full Benchmark Playtest

Only after Phases 1–3 should *Beyond the Vale of Madness* be treated as a **full-fidelity Tiwas playtest**, rather than an integration diagnostic.

---

# 20. Final Findings

## F-01 — Core Resolution
...
## F-02 — Resource/Progression Integration
...
## F-04 — Combat Consequence Specification
...
`Core Test → S-1 → Effect → Defense → Location → Wound/Condition → Incapacitation`

---
document:
  title: "Tiwas TTRPG â€” Ice Troll Combat Playtest Cross-Reference Report"
  version: "1.0"
...
# Tiwas TTRPG â€” Ice Troll Combat Playtest Cross-Reference Report

**Document Type:** Formal Project Documentation / Comparative Playtest Analysis  
**Status:** Advisory â€” Non-Canonical  
**Date:** 2026-09-04  
...
|---|---|---|---|---|
| **L1 â€” Grok Full** | Grok 4.5 | 22 rounds | PC HP = 0 (incapacitated); Troll HP = 412 | Independent full run |
| **L2 â€” Claude Abort** | Claude Sonnet 5 | 2 rounds / 4 exchanges | Explicit abort; PC HP = 585; Troll HP = 698 | Independent short run |
| **L3 â€” Luna Continuation** | GPT-5.6 Luna | Continuation of L2 to termination | PC HP = 0 (incapacitated); Troll HP = 569 | Direct continuation of L2 state |
...
| Advanced Skills created | 0 (no qualifying failed Doubles) | 1 (Exchange 3, 100-Fumble) | â‰¥1 additional (failed 99) |
| Frightened applied | Not selected | Yes (Tier-2, âˆ’2) | Carried forward from L2 |
...
| Designer Override used | None | None | â€œRound 1, Exchange 1 â€” PC attacksâ€ (playtest-only) |
...
| Label | Definition |
|---|---|
| **Exercised â€” Functional** | Pathway executed end-to-end under existing Ruled/Locked text; no scaffold required. |
| **Exercised â€” Scaffolded** | Pathway executed, but required a non-canonical numeric or substitution value. |
| **Exercised â€” Interpretive** | Pathway reached; corpus silent; conservative interpretation applied (no new numeric invented). |
...
### 3.1 Core Resolution Layer (DEC-001â€“DEC-012)

| System | L1 | L2 | L3 | Consensus Status |
|---|---|---|---|---|
| d100 roll-under, 100-Fumble, Doubles | Functional | Functional | Functional | **Exercised â€” Functional** |
| Floor rounding (DEC-002) | Functional | Functional | Functional | **Exercised â€” Functional** |
| Derived statistics live (DEC-004) | Functional | Functional | Functional | **Exercised â€” Functional** |
| Skill Cap / Starting Value (DEC-005) | Functional | Functional | Functional | **Exercised â€” Functional** |
| 9-step Core Test Transaction (DEC-006) | Functional | Functional | Functional | **Exercised â€” Functional** |
| Cost = natural roll; Overflow â†’ HP (DEC-007 / 007.A) | Functional | Functional | Functional | **Exercised â€” Functional** |
| Recovery floor(Regen/2) clamped (DEC-008) | Functional | Functional | Functional | **Exercised â€” Functional** |
| Failure XP â†’ Skill Roll Pool cascade (DEC-009 / 010) | Functional | Functional | Functional | **Exercised â€” Functional** |
| Advanced Skill creation via failed Double (DEC-012) | Idle (no Double) | Functional (1 created) | Functional (â‰¥1 created) | **Exercised â€” Functional** |
...
| System | L1 | L2 | L3 | Consensus Status |
|---|---|---|---|---|
| S-1 Universal Opposed Contest (DEC-013) | Functional | Functional | Functional | **Exercised â€” Functional** |
| Quality comparison (Margin / Blackjack / Hybrid) | Blackjack scaffolded | Used | Used | **Exercised â€” Scaffolded** (mode selection) |
| Base-tier Inflict Injury (DEC-023) | Scaffolded (flat 25 HP) | Scaffolded (winner Margin) | Scaffolded (winner Margin) | **Exercised â€” Scaffolded** |
| Active Defense post-hoc mitigation (DEC-044â€“050) | Scaffolded (âˆ’20 HP or full cancel) | Scaffolded (defender Margin / 0) | Scaffolded (defender Margin / 0) | **Exercised â€” Scaffolded** |
| Effect auto-apply + sequential Track A/B (DEC-027 / 034) | Functional | Functional | Functional | **Exercised â€” Functional** |
| HP = 0 forced incapacitation (DEC-052) | Functional | Not reached | Functional | **Exercised â€” Functional** |
| Quality â‰¥ 1 Base-tier floor (DEC-031) | Functional | Functional | Functional | **Exercised â€” Functional** |
| Gated-tier Quality unlock threshold | Not exercised | Scaffolded (â‰¥10) | Scaffolded (â‰¥10) | **Exercised â€” Scaffolded** |
| Defender-wins opposed attack Effect rights | Not reached | Interpretive (no counter-Effect) | Interpretive (no counter-Effect) | **Exercised â€” Interpretive** |
...
| System | L1 | L2 | L3 | Consensus Status |
|---|---|---|---|---|
| Zero-Step Location Index (DEC-014) | Idle | Exercised | Exercised | **Exercised â€” Functional** (provider) |
| Anatomical zone ranges (DEC-041) | Idle | Scaffolded (quartiles) | Scaffolded (quartiles) | **Exercised â€” Scaffolded** |
| Wound creation (DEC-035.A/.B) | Idle | Functional | Functional | **Exercised â€” Functional** (architecture) |
| Wound consequences (OPEN-007) | Idle | Not fully exercised | Not fully exercised | **Idle / Gap** (consequences) |
| Frightened Condition (DEC-079) | Idle | Functional (via won Effect) | Carried | **Exercised â€” Functional** (application) |
...
| Dedicated defensive skill on creature block | Absent â†’ Brawling substituted (scaffold) |
...
|---|---|---|---|
| Inflict Injury magnitude (Base-tier) | Flat 25 HP | Winnerâ€™s Margin | Different numerical philosophies; both produce playable attrition |
| Active Defense mitigation | âˆ’20 HP (or full cancel) | Defenderâ€™s Margin (0 on failure) | L1 produces slower net attrition; L2/L3 faster |
| Quality mode | Blackjack | Implicit Margin-style | DEC-013 permits choice; no locked default |
| Quality gated-tier unlock | Not used | â‰¥ 1 Base / â‰¥ 10 gated | DEC-031 silent on numeric threshold |
| Location-Tier-1 zones | Not used | 1â€“25 Legs / 26â€“50 Torso / 51â€“75 Arms / 76â€“100 Head | DEC-041 leaves ranges directional |
| Creature defensive skill | Brawling (Tier-1 â‰ˆ 37) | Brawling (Tier-1) | Substitution only |
| Initiative / first actor | Higher Speed acts first | Designer Override (â€œPC attacksâ€) | Playtest-only; not general rule |
| Frightened magnitude | âˆ’10 (prepared, unused) | âˆ’2 (Tier-2 applied) | Different scales |
...
|---|---|---|---|---|
| U-01 | Inflict Injury (Base-tier) numeric magnitude | All three | Scaffold dependency | **Critical** â€” combat cannot be deterministic |
| U-02 | Active Defense mitigation numeric amount | All three | Scaffold dependency | **Critical** â€” defence loop incomplete |
| U-03 | Quality â†’ gated-tier unlock threshold | L2, L3 | Scaffold dependency | **High** â€” Condition / Position / Equipment Effects gated |
| U-04 | Location-Tier-1 coarse-zone numeric ranges | L2, L3 | Scaffold dependency | **Mediumâ€“High** (if location-referencing Effects used) |
| U-05 | General combat action sequencing / initiative | All three | Absent procedure | **Critical** â€” every combat requires ad-hoc order |
| U-06 | Passive / aura Frightened trigger | L2 (GM-stop), L1 avoided | Absent subsystem | **High** for Ice Troll / Blood Man fidelity |
| U-07 | Defender-wins opposed attack â†’ Effect rights | L2, L3 | Interpretive gap | **Medium** â€” frequency depends on roll outcomes |
| U-08 | Creature dedicated defensive skill | All three | Content gap in v0.2 block | **Medium** â€” substitution works but is not design |
| U-09 | Wound consequences catalogue (OPEN-007) | All (idle or partial) | Not table-ready | **Medium** â€” â€œwoundedâ€ state incomplete |
...
2. Failure XP â†’ Skill Roll Pool cascade and Cap-limited advancement.
...
| **P1** | Passive Condition triggers (Frightened aura) | Adventure and Ice Troll Appearance demand it | Trigger rule or explicit â€œwon-Effect onlyâ€ confirmation |
...
| **P2** | Wound consequences (OPEN-007) | â€œWoundedâ€ state currently label-only | Penalty / healing-cost catalogue |
...
| **P3** | Environmental hazard magnitude (falls, cold) | Adventure survival layer | Hazard â†’ Effect / HP procedure |
...
2. **Magnitude divergence:** L1 (flat 25 / âˆ’20) produces slower attrition than L2/L3 (Margin-based). Both are internally consistent; neither is canonical. A locked formula is required before results can be compared quantitatively across future playtests.
...
| Lineages kept distinct | Documentarian notes already separate L1 from L2â†’L3 |
| GM-stops recorded rather than papered over | L2 recorded passive Frightened stop |

No lineage violated the standing â€œreconfirmation-before-recordingâ€ rule.
...
2. **Present** U-01 through U-11 (or the prior CANDIDATE-01â€¦09 set) to Tiwa as individual ruling items.
...
Until those items receive designer rulings and are recorded under the projectâ€™s formal promotion process, any further combat execution must continue to carry explicit scaffold and interpretive-gap declarations.
...
- Lineage structure, priority classification, and scaffold divergence finding accurately reported.
- No DEC numbers assigned. No rulings made. Classification preserved: advisory.
- **assessor_llm and last_modified_by_llm fields added** (originally missing from YAML); **last_modified_date** retained.

...
| 3. Instantaneous or persistent | Persistent by definition — a Condition without duration is not distinguishable from an instantaneous Effect, but exact duration/removal rules are Reserved (Proposals §10), not fixed here. |
...
| 9. S-5/S-6 interaction | **Direct** — Armor (S-5) is explicitly named as a target category for this Effect (Proposals §13 lists "equipment damage" under Equipment's required areas, and S-5's own scope includes "Bypass-style armour interaction," Proposals §5). This Effect's full identity cannot be fixed independent of both S-5 and Equipment. |

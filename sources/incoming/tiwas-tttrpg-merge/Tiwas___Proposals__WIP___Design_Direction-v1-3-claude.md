...
This selection is further supported by exhaustive comparative analysis against the candidate alternative, Units-Digit (Canonical Rules §14.6).
...
**Evidence class: Empirical finding**
...
Participants reported no difficulty rolling the dice or exchanging the digits for hit location, and feedback was positive. This evidence addressed human usability of Zero-Step with physical d10s; it did not settle the remaining architecture.

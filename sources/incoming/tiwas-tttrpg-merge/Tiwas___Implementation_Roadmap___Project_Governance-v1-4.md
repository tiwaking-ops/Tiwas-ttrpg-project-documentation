...
**Supersedes:** Implementation Roadmap & Project Governance v1.3  
...
| 2 | S-2 | Hit-location architecture | **Tier-1 provider: Locked (Zero-Step, evidence-backed) / Tier policy: WIP** | S-1 |
...
This corrects a prior drafting inconsistency where this diagram showed S-3 preceding S-2, while §4's priority table and the Phase numbering (§9–§10) both already treated S-2 as preceding S-3. The linear order above now matches those.

**Open question, not resolved by this correction:** whether S-2 and S-3 are better modeled as strictly sequential (as shown) or as parallel branches that both feed S-4 — since some S-3 Effects (e.g. "Choose Location") consume location data while most do not, and S-2 has no corresponding dependency on S-3. This is a substantive architecture question, not a documentation defect, and belongs to whoever next works on S-3, not to this correction pass.
...
**Status: Tier-1 provider locked (Zero-Step, evidence-backed) / Tier 0/1/2 policy and broader architecture WIP**

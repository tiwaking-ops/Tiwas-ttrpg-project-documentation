...
| T3 — Hybrid Eligibility/Capacity/Selection (current draft) | No conflict identified | Medium | Medium–High | Live candidate; current Proposals/WIP draft shape *[reworded, correction 4]* |
...
| "Choose Location" Interpretation B (choose the Index result) | **Excluded from current S-3 design space** *[wording regression fixed, correction 5]* — conflicts with locked Canonical §14.2; reopening requires an explicit Canonical §14.2 reopening, not an S-3-level decision |

...
**No changes in this pass.** Nothing in the v1.4.2 Proposals/WIP or Roadmap merge touches this document — S-2 remains locked only to the extent already stated in §14 below (Zero-Step, the Tier-1 Location Index provider). The S-2 Design Investigation's candidate invocation policy is accepted only as non-canonical material in Proposals/WIP; it does not modify anything here. Included in this delivery only so the three consolidated documents remain a matched set.

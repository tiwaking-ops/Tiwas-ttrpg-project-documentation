---
document:
  title: "Tiwas — Proposals, WIP & Design Direction"
  version: "v1.4.3"
  status: "Non-canonical (self-declared: \"Non-Canonical Design Repository\")"
provenance:
...
consolidation_note: >
  Placed in proposals/ during initial consolidation (2026-08-29). Content below
  the header is UNMODIFIED from sources/tiwas-proposals-wip-and-design-direction-v1.4.3.md.
  Contains several real non-canonical designer rulings (see
  _consolidation/decision-register.md section B) — none promoted to Canonical
  by this consolidation; the 8-step Promotion Rule (this document's own §21)
  has not been run for any of them.
---
